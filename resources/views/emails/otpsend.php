...
<html><head>
   ...
   <body style=" padding:10px;  font-family: Poppins, sans-serif;background:#6BB4C8">
    ...
    border-radius: 7px!important;">
                              ...
                              <p style="margin-top:20px;margin-bottom:15px;font-weight:600;font-size:16px;text-align: center;color: #000;">Do not share your login details with anyone:</p>
                            ...
                            <!--  <p style="text-align:center;color: #fff; font-size: 18px;">
                             ...
                             <p style="text-align:center;color: #000; font-size: 18px;">You can login here: <a href="'.$url.'" target="_blank" style="color:#23D0E1;text-decoration: none;"> '.$url.'</a></p>
