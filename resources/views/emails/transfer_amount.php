                        ...
                        <tr>
                           <td>
                            ...
                            <!--  <p style="text-align:center;color: #fff; font-size: 18px;">
                             ...
                             <p style="text-align:center;color: #000; font-size: 18px;margin-top:40px">You can login here: <a href="'.$url.'" target="_blank" style="color:#23D0E1;text-decoration: none;font-weight:600"> '.$url.'</a></p>
