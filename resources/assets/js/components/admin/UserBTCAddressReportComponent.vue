	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">User BTC Address Report</h4>
		    </div>
		</div>
		    ...
		    <div class="container">
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="user-btc-address-report" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
		                                    <th>Sr.No</th>
                                            <th>User ID</th>
    ...
    export default {
        ...
        methods: {
            ...
            productReport(){
                ...
                setTimeout(function(){
                    that.table = $('#user-btc-address-report').DataTable({
                        responsive: true,
                       ...
                       dom: 'Brtip',
                        ...
                        ajax: {
                            url: apiAdminHost+'/show/user/addresses',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
