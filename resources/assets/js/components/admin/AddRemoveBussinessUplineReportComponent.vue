	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Add And Remove Business Upto Upline Report</h4>
		    </div>
		</div>
		            ...
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        ...
		                        <table id="upline-bussiness-report" class="table table-striped table-bordered dt-responsive">
		                            <thead>
                                        <tr>
                                            <th>Sr.No</th>                            
                                            <th>User Id</th>
    ...
    export default {
        ...
        methods: {
            powerReport(){
                ...
                setTimeout(function(){
                    const table = $('#upline-bussiness-report').DataTable({
                        retrieve: true,
                        destroy: true,
                        processing: false,
                        serverSide: true,
                        ...
                        ajax: {
                            url: apiAdminHost+'/upline-bussiness-report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
