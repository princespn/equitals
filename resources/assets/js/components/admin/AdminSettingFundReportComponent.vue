...
<div class="content">
	<div class="">
	    <div class="page-header-title">
	        <h4 class="page-title">Add Development Bonus Report</h4>
	    </div>
	</div>
	    ...
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-md-12">
	                <div class="panel panel-primary">
	                    <div class="panel-body">
	                        <table id="admin-setting-fund-report" class="table table-striped table-bordered dt-responsive">
	                            <thead>
	                                <tr>
	                                   <th>Sr No</th>
                                       <th>User Id</th>
                                        <th>Amount</th>
                                        <th>Topup Percentage</th>
                                        <!-- <th>Status</th> -->
                                        <th>Remark</th>
                                        <th>IP Adrress</th>
                                        <th>Date</th>  
    ...
    export default {
        ...
        methods: {
            ...
            productReport(){
                ...
                setTimeout(function(){
                    const table = $('#admin-setting-fund-report').DataTable({
                        responsive: true,
                        retrieve: true,
                        destroy: true,
                        processing: false,
                        ...
                        ajax: {
                            url: apiAdminHost+'/add_setting_fund_report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
