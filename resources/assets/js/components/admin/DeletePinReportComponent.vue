	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Delete E-Pin Report</h4>
		    </div>
		</div>
		    ...
		    <div class="container">	
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="delete-pin-history" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
                                            <th>Sr.No</th>
		                                    <th>E-Pin</th>
    ...
    export default {
        ...
        methods: {
            ...
            manageWhatsNew(){
                ...
                setTimeout(function(){
                    const table = $('#delete-pin-history').DataTable({
                        responsive: true,
                        ...
                        columns: [
                            ...
                            {
                                render: function (data, type, row, meta) {
                                    if (row.updated_at === null || row.updated_at === undefined || row.updated_at === '') {
                                      return `-`;
                                    } else {
                                        return moment(String(row.updated_at)).format('YYYY-MM-DD');
                                    }
                                }
                            },
                            {
                              render: function (data, type, row, meta) {
                                    return '<label type="submit" class="text-danger">'+row.pin_status+'</label>';
                                }
                            },  
                            /*{
                              render: function (data, type, row, meta) {
