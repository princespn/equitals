	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Remove DX Wallet Fund</h4>
		    </div>
		</div>
                                    ...
                                    <form id="addFund">
                            			<div class="col-md-5 col-md-offset-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="amount" name="amount" v-model="fund.amount"  placeholder="Enter amount" v-validate="'required|decimal:3'">
           ...
           getUserDetails(){
			...
			checkUserExisted(){
				axios.post('/checkuserexist',{
                    ...
                    if(resp.data.code === 200){
                        ...
                        this.balance = Number(resp.data.data.acc_wallet).toFixed(2);
                    } else {
                    	this.fund.user_id = '';
            ...
            this.$validator.validate().then(valid => {
              if (valid) {
                ...
                axios.post('remove_dxwallet_fund',
                    formData,{
                        headers: {
                      ...
                      if(response.data.code==200){
                           ...
                           this.$router.push({name: 'adminremovedxwalletfundreport'});
