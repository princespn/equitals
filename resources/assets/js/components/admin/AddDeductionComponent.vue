    ...
    <div class="content">
        <div class="">
            <div class="page-header-title">
                <h4 class="page-title">Add Deduction</h4>
            </div>
        </div>
                                    ...
                                    <form id="addDeduction">
                                        <div class="col-md-5 col-md-offset-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="product_id" class="form-control" v-model="fund.wallet" id="product_id" @change="changeSelect($event)" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="amount" name="amount" v-model="fund.amount"  placeholder="Enter amount" v-validate="'required|numeric'">
                                            ...
                                            <div class="col-md-offset-5">
                                                <button type="button" class="btn btn-primary text-center" :disabled = "!isComplete || errors.any()" @click="fund_dect">Submit</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
<script>
    ...
    //  this.getUserDetails();
        ...
        computed: {
            isComplete () {
                return this.fund.user_id && this.fund.amount && this.fund.wallet && this.balance;
            }
        ...
        methods: {
          ...
          changeSelect(){
            if (this.fund.wallet == 1) {

                 this.balance = this.acc_balance;

            }else if (this.fund.wallet == 2) {

                 this.balance = this.working_balance;
            ...
            if (this.fund.amount > this.balance) {
                this.$toaster.error('Insufficent Balance')
                return false;
            }
            this.$validator.validate().then(valid => {
              if (valid) {
                ...
                formData.append('type', this.fund.wallet);
                axios.post('fund_deduction',
                    formData,{
                        headers: {
