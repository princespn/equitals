...
<div class="content">
	<div class="">
	    <div class="page-header-title">
	        <h4 class="page-title">Remove Fund Report</h4>
	    </div>
	</div>
    ...
    export default {
            ...
            productReport(){
                ...
                setTimeout(function(){
                    const table = $('#admin-fund-report').DataTable({
                        ...
                        ajax: {
                            url: apiAdminHost+'/remove_fund_report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
       ...
       //                      { data: 'franchise_user_id' },
            ...
            exportToExcel(){
                ...
                axios.post('remove_fund_report', params).then(resp => {
                    if(resp.data.code === 200){
                        ...
                        fileLink.setAttribute('download', 'removefund.xls');
