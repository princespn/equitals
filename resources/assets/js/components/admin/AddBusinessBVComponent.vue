   ...
   <div class="content">
      <div class="">
         <div class="page-header-title">
            <h4 class="page-title">Add And Remove Business BV Amount</h4>
         </div>
      </div>
                        ...
                        <div class="">
                           <form id="change-user-password" @submit.prevent="">
                            ...
                            <div class="form-group">
                                    ...
                                    <select name="action" v-model="type" class="form-control">
                                    <option selected value="">Select</option>
                                    <option value="1">Add Business Upto Admin </option>
                                    <option value="2">Remove Business Upto Admin</option>
...
export default {
    ...
    methods: {
        ...
        addPower() {
          if(this.type == '')
            ...
            .then(response=>{
                if(response.data.code == 200) {
                    ...
                    this.$router.push({name: 'add-remove-bussiness-upline-report'});
                }else{
         ...
         sendOTP() {
            var arr = {};
            axios.post("sendOtp-add-topup", {otp_type:7})
               .then((response) => {
               if (response.data.code == 200) {
