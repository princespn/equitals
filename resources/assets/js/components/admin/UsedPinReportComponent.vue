	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Used E- Pin Report</h4>
		    </div>
		</div>
		    ...
		    <div class="container">	
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="used-pin-report" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
                                            <th>Sr.No</th>
		                                    <th>E-Pin</th>
    ...
    export default {
        ...
        methods: {
            ...
            manageWhatsNew(){
                ...
                setTimeout(function(){
                    const table = $('#used-pin-report').DataTable({
                        responsive: true,
                                ...
                                render: function (data, type, row, meta) {
                                    if (row.used_date === null || row.used_date === undefined || row.used_date === '') {
                                      return `-`;
                                        ...
                                        return moment(String(row.used_date)).format('YYYY-MM-DD');
                                    }
                                }
                            },
                            {
                              render: function (data, type, row, meta) {
                                    return '<label type="submit" class="text-warning">'+row.pin_status+'</label>';
                                }
                            },  
                            /*{
                              render: function (data, type, row, meta) {
