		                                ...
		                                <div class="text-center"> 
			                                 <div class="col-md-2" >
			                                    <div class="form-group">
								                    ...
								                    <!-- <a _ngcontent-c13="" class="btn btn-primary waves-effect waves-light" routerlink="/panel-side/manage-theme/edit-news/0" ng-reflect-router-link="/panel-side/manage-theme/edit-" href="/productbase/admin/panel-side/manage-theme/edit-news/0" @click="addNews"><i _ngcontent-c13="" class="fa fa-plus"></i>Add News</a> -->
								                </div>
			                                </div>	
		                                </div>	                           
		                               <!--  <div class="col-md-2">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            addNews(){
            	this.id = 0;
            	this.$router.push({ name: 'addeditnews', params: {id: this.id}})
            },
            deleteNews(id){
                Swal({
                    title: 'Are you sure?',
