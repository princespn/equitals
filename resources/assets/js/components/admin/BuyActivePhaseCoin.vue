    ...
    <div class="content">
        <div class="">
            <div class="page-header-title">
                <h4 class="page-title">Buy Active Phase Token</h4>
            </div>
        </div>
                                    ...
                                    <form id="addFund">
                                        <div class="col-md-5 col-md-offset-3">
                                            ...
                                            <div class="form-group">
                                                <label>User Id</label>
                                                <input type="text" name="username" class="form-control" id="username" placeholder="User Id" v-model="username" readonly v-on:keyup="checkUserExisted">
    ...
    created(){
      this.getUserDetails();
        ...
        mounted() {
            ...
            this.checkUserExisted(this.username);
        },
        methods: {
