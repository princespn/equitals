	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Deposit Transactions Pending</h4>
		    </div>
		</div>
		    ...
		    <div class="container">
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="deposit-transactions-pending" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
		                                    <th>Sr.No</th>
                                            <th>User Id</th>
                ...
                <div class="modal fade" id="deposit-pending-model">
    ...
    export default {
        ...
        methods: {
            ...
            productReport(){
                ...
                setTimeout(function(){
                    that.table = $('#deposit-transactions-pending').DataTable({
                        responsive: true,
                        retrieve: true,
                        destroy: true,
                        processing: false,
                        ...
                        /*ajax: {
                            url: apiAdminHost+'/getaddrtranspendings',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
                        ...
                        columns: [
                            ...
                            {
                               render: function (data, type, row, meta) {
                                    return '<label class="text-success waves-effect" id="deposite-pending">Details</label>';
                    ...
                    $('#deposit-transactions-pending').on('click','#deposite-pending', function (){
                        //$('#deposit-pending-model').modal();      
