...
<div class="content">
	<div class="">
	    <div class="page-header-title">
	        <h4 class="page-title">Purchase Balance Transfer Report</h4>
	    </div>
	</div>
	    ...
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-md-12">
	                <div class="panel panel-primary">
	                    <div class="panel-body">
	                        <table id="purchase-balance-transfer-report" class="table table-striped table-bordered dt-responsive">
	                            <thead>
	                                <tr>
	                                    <th>Sr No</th>
                                        <th>User ID</th>
    ...
    export default {
        ...
        methods: {
            ...
            productReport(){
                ...
                setTimeout(function(){
                    const table = $('#purchase-balance-transfer-report').DataTable({
                        responsive: true,
                        retrieve: true,
                        destroy: true,
                        processing: false,
                        ...
                        ajax: {
                            url: apiAdminHost+'/purchase_balance_transfer_report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
                        ...
                        columns: [
                            ...
                            /*{ data: 'amount' },*/
                              ...
                              { render: function (data, type, row, meta,) {
                                   return `<span>$${row.transferred_amount}</span>`;
                            ...
                            },
                            {
                                render: function (data, type, row, meta) {
                                    if (row.status == 0) {
                                        ...
                                        return `<label class="text-danger">Rejected</label>`;
                                    }
                                }
                            },
                            {
            ...
            exportToExcel(){
                ...
                axios.post('balance_transfer_report', params).then(resp => {
                    if(resp.data.code === 200){
                        ...
                        fileLink.setAttribute('download', 'purchasebalancetransfer.xls');
