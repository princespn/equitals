	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Pending Promotional Report</h4>
		    </div>
		</div>
        ...
        <div class="modal fade" id="promotional-status" role="dialog">
            <div class="modal-dialog">
                <!-- Modal content-->
                <div class="modal-content">
                    <form @submit.prevent="approveRejectRequest">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">{{(status=='rejected')?'Reject':'Approve'}} Promotional</h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label> Remark</label>
                                        <textarea class="form-control" name="remark" placeholder="Enter Remark" id="remark" v-model="remark" v-validate="'required'"></textarea>
