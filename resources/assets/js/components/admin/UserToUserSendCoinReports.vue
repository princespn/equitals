...
<div class="content">
	<div class="">
	    <div class="page-header-title">
	        <h4 class="page-title">User To User Send Token Reports</h4>
	    </div>
	</div>
	    ...
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-md-12">
	                <div class="panel panel-primary">
	                    <div class="panel-body">
	                        <table id="ico-user-send-rep" class="table table-striped table-bordered dt-responsive">
	                            <thead>
	                                <tr>
	                                   <th>Sr No</th>
                                        <th>To User Id</th>
    ...
    export default {
        ...
        methods: {
            ...
            productReport(){
                ...
                setTimeout(function(){
                    const table = $('#ico-user-send-rep').DataTable({
                        responsive: true,
                        retrieve: true,
                        destroy: true,
                        processing: false,
                        ...
                        ajax: {
                            url: apiAdminHost+'/getUserToUserSendCoinRep',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
