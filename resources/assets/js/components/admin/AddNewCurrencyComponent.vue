...
<!-- 
                                            ...
                                            <div class="form-group">
    											...
    											<input type="text" name="currency_name" class="form-control" id="currency_name" placeholder="Currency Name" v-model="currency_name" >
    											</div>
                                            
                                             <div class="form-group">
    											<label>Currency Code</label>
    											<input type="text" name="currency_code" class="form-control" id="currency_code" placeholder="Currency Code" v-model="currency_code">
    											</div>
                                            
                                            <div class="form-group">
                                                <label>Status</label>
                                                <select name="currency_status" class="form-control"  id="currency_status"  v-model="currency_status" >
                                                    <option :value="0">InActive</option>
                                                     <option :value="1">Active</option>
                                                    <!--<option v-for="product_id in product_ids" v-bind:value="product_id.id" :key="product_id"> {{ product_id.name }}</option> -->
                                                </select>
                                            </div>
                                             <div class="form-group">
                                                <label>Withdrwal Status</label>
                                                <select name="withdrwal_status" class="form-control"  id="withdrawl_status" v-model="withdrwal_status" >
                                                    <option :value="0">InActive</option>
                                                     <option :value="1">Active</option>
                                                    <!--<option v-for="product_id in product_ids" v-bind:value="product_id.id" :key="product_id"> {{ product_id.name }}</option> -->
                                                </select>
...
-->
                      ...
                      title="Numbers only"  v-model="topup.hash_unit" v-validate="'required|numeric'" v-on:keyup="hashvalidation" >
  											...
  											<div class="col-md-offset-5">
  												<button type="button" class="btn btn-primary text-center" @click="addTopUp">Submit</button>
  											</div>
										</div>
                                	</form>
                            	</div>
