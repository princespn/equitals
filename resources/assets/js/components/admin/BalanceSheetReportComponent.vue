		    ...
		    <div class="container">
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="balance-sheet-report" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
		                                    <th>Sr.No</th>
		                                    <th>User Id</th>
		                                    <th>Fullname</th>
                                            <th>Coinpayment Deposit</th>
                                            <th>ROI</th> 
                                            <th>Direct</th> 
                                            <th>Binary</th>
                                            <th>Supermatching</th>
    ...
    export default {
        ...
        methods: {
            ...
            productReport(){
                ...
                setTimeout(function(){
                    const table = $('#balance-sheet-report').DataTable({
                        responsive: true,
                        retrieve: true,
                        destroy: true,
                        processing: false,
                        ...
                        ajax: {
                            url: apiAdminHost+'/getbalancesheetreport',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
                        ...
                        columns: [
                            ...
                            { data: 'user_id' },
                            { data: 'fullname' },
                            { data: 'coinpayment_funds' },
                            { data: 'roi_income' },
                            { data: 'direct_income' },
                            { data: 'binary_income' },
                            { data: 'supermatching_income' },
                            { data: "freedom_club_income" },
                            { data: "credit_fund" },
                           { data: "debit_fund" },
                            // {
                            //     render: function (data, type, row, meta) {
                            //         return row.total_roi + row.total_binary + row.supermatching_income + row.club_income;
                            //     }
                            // },
                            {
                                render: function (data, type, row, meta) {
