	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Appproved KYC Report</h4>
		    </div>
		</div>
		    ...
		    <div class="container">
		                                ...
		                                <div class="text-center"> 
			                                 <div class="col-md-2" >
			                                    <div class="form-group">
			                                        <label>User Id</label>
			                                        <input class="form-control" required="" placeholder="Enter user id" id="user_id" type="text" f>
			                                    </div>
			                                </div>	
		                                </div>	                           
		                               <!--  <div class="col-md-2">
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="approved-kyc-report" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
		                                    <th>Sr.No</th>
		                                    <th>User Id</th>
    ...
    export default {
        ...
        methods: {
            approvedKYCReport(){
                ...
                setTimeout(function(){
                    const table = $('#approved-kyc-report').DataTable({
                        responsive: true,
                        ...
                        columns: [
							...
							{ data: 'remark_shop_act' },
                            {
                              render: function (data, type, row, meta) {
                                 return '<label class="text-info">Approved</label>';
                              }
                            },
