...
<div class="content">
	<div class="">
	    <div class="page-header-title">
	        <h4 class="page-title">Working To Purchase Wallet Transfer Report</h4>
	    </div>
	</div>
	    ...
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-md-12">
	                <div class="panel panel-primary">
	                    <div class="panel-body">
	                        <table id="dex-to-purchase-report" class="table table-striped table-bordered dt-responsive">
	                            <thead>
	                                <tr>
	                                    <th>Sr No</th>
                                        <th>User</th>
    ...
    export default {
        ...
        methods: {
            ...
            productReport(){
                ...
                setTimeout(function(){
                    const table = $('#dex-to-purchase-report').DataTable({
                        responsive: true,
                        retrieve: true,
                        destroy: true,
                        processing: false,
                        ...
                        ajax: {
                            url: apiAdminHost+'/dex_to_purchase_transfer_report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
                        ...
                        columns: [
                            ...
                            {
                                render: function (data, type, row, meta) {
                                    return `<span>${row.user_id}</span><br><span>(${row.name})</span>`;
                                }
                            },
                            /*{
                                render: function (data, type, row, meta) {
            ...
            exportToExcel(){
                ...
                axios.post('dex_to_purchase_transfer_report', params).then(resp => {
                    if(resp.data.code === 200){
                        ...
                        fileLink.setAttribute('download', 'fundtransferreports.xls');
