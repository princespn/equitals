...
<div class="content">
    <div class="">
        <div class="page-header-title">
            <h4 class="page-title">Fake Topup Reports</h4>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <table id="faketopup-report" class="table table-striped table-bordered dt-responsive">
                                <thead>
                                    <tr>
                                        <th>Sr.No</th>
                                        <th>User</th>
    ...
    export default {
        ...
        methods: {
            ...
            getFakeTopupReport(){
                ...
                setTimeout(function(){
                    const table = $('#faketopup-report').DataTable({
                        responsive: true,
                        retrieve: true,
                        destroy: true,
                        processing: false,
                        ...
                        ajax: {
                            url: apiAdminHost+'/fake_topup_report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
                        ...
                        columns: [
                            ...
                            {
                                render: function (data, type, row, meta) {
                                    return row.to_user_id+" ("+row.to_name+")";
                                }
                            },
                            {
                                render: function (data, type, row, meta) {
                                    return row.from_user_id+" ("+row.from_name+")";
                                }
                            },
                            { data: 'amount' },
                            { data: 'pin' },
            ...
            exportToExcel(){
                ...
                axios.post('fake_topup_report', params).then(resp => {
                    ...
                    fileLink.setAttribute('download', 'FakeTopups.xls');
