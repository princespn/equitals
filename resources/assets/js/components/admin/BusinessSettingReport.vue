	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Business Setting Report</h4>
		    </div>
		</div>
		    ...
		    <div class="container">
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="downline-user-report1" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
		                                  <th>Sr.No</th>
                                            <th>User Id</th>
    ...
    export default {
        ...
        methods: {
            ...
            downlineUsersReport(){
                ...
                setTimeout(function(){
                   const table = $('#downline-user-report1').DataTable({
                        responsive: true,
                        ...
                        ordering: false,
                        ajax: {
                            url: apiAdminHost+'/businessSetting',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
