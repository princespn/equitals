...
<div class="content">
    <div class="">
        <div class="page-header-title">
            <h4 class="page-title">Fake Withdraw Reports</h4>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <table id="fakewithdraw-report" class="table table-striped table-bordered dt-responsive">
                                <thead>
                                    <tr>
                                        <th>Sr.No</th>
                                        <th>User</th>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getFakewithdrawReport(){
                let i = 0;
                let that = this;
                let token = localStorage.getItem('access_token');
                setTimeout(function(){
                    const table = $('#fakewithdraw-report').DataTable({
                        responsive: true,
                        retrieve: true,
                        destroy: true,
                        processing: false,
                        ...
                        ajax: {
                            url: apiAdminHost+'/fake_withdraw_report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
                        ...
                        columns: [
                            ...
                            {
                                render: function (data, type, row, meta) {
                                    return row.user_id+" ("+row.fullname+")";
                                }
                            },
                            { data: 'amount' },
                            { data: 'wallet_type' },
            ...
            exportToExcel(){
                ...
                axios.post('fake_withdraw_report', params).then(resp => {
                    ...
                    fileLink.setAttribute('download', 'FakeWithdraw.xls');
