	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Rejected KYC Report</h4>
		    </div>
		</div>
		    ...
		    <div class="container">
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="rejected-kyc-report" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
		                                    <th>Sr.No</th>
		                                    <th>User Id</th>
    ...
    export default {
        ...
        methods: {
            rejectedKYCReport(){
                ...
                setTimeout(function(){
                   const table =  $('#rejected-kyc-report').DataTable({
                        responsive: true,
