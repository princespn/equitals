	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Reward Acheivers Report</h4>
		    </div>
		</div>
		    ...
		    <div class="container">
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="reward-acheiver-report" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
		                                    <th>Sr.No</th>
		                                    <th>User Id</th>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            rewardAcheiverReport(){
            	let i = 0;
                let that = this;
                let token = localStorage.getItem('access_token');
                setTimeout(function(){
                    const table = $('#reward-acheiver-report').DataTable({
                        responsive: true,
                        ...
                        ordering: false,
                        ajax: {
                            url: apiAdminHost+'/report/awardwinners',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
