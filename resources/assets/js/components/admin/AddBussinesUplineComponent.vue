                              ...
                              <div class="col-md-5 col-md-offset-3">
                                 ...
                                 <div class="form-group">
                                    <label for="power bv">Enter Business</label>
                                     <input type="text" class="form-control" id="bussiness" name="bussiness" v-model="bussiness" placeholder="Enter Business Amount" v-validate="'required|integer|min_value:1'">
                                    <div class="tooltip2" v-show="errors.has('bussiness')">
                                       <div class="tooltip-inner">
                                          <span v-show="errors.has('bussiness')">{{ errors.first('bussiness') }}</span>
                                       </div>
                                    </div>
                                 </div>
                                  <div class="form-group"> 
    ...
    methods: {
        ...
        addPower() {
          if(this.type == '')
            ...
            axios.post('add-bussiness-upline',{
                id: this.id,
