    ...
    <div class="content">
	    <div class="">
	        <div class="page-header-title">
	            <h4 class="page-title">User Link Reports</h4>
	        </div>
	    </div>
	        ...
	        <div class="container">
	            ...
	            <div class="row">
	                <div class="col-lg-12">
	                    <div class="panel panel-primary">
	                        <div class="panel-body">
	                            <table class="table table-striped table-bordered dt-responsive" id="user-link-report">
                                    <thead>
	                                    <tr>
	                                        <th>Sr.No</th>
	                                        <th>User ID</th>
       ...
       // mixins: [formatDates],
        methods: {
            ...
            linkReport(){
                ...
                setTimeout(function(){
                	let i = 0;
                    const table = $('#user-link-report').DataTable({
                        ...
                        ordering: false,
                        ajax: {
                            url: apiAdminHost+'/user-link-report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
                        ...
                        columns: [
                           {
                            ...
                            {
                                 render: function (data, type, row, meta) {
                                return '<a target="_blank" href="'+row.facebook_link+'">'+row.facebook_link+'</a>';
                                }
                            },
                            {
                                 render: function (data, type, row, meta) {
                                return '<a target="_blank" href="'+row.twitter_link+'">'+row.twitter_link+'</a>';
                                }
                            },
                            {
                                 render: function (data, type, row, meta) {
                                return '<a target="_blank" href="'+row.linkedin_link+'">'+row.linkedin_link+'</a>';
                                }
                            },
                             {
                                 render: function (data, type, row, meta) {
                                return '<a target="_blank" href="'+row.instagram_link+'">'+row.instagram_link+'</a>';
                                }
                            },
                            {
                                render: function (data, type, row, meta) {
