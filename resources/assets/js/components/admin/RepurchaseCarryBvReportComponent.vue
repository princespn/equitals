		    ...
		    <div class="container">
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="repurchase-carrybv-report" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
		                                    <th>Sr.No</th>
		                                    <th>User Id</th>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.repurchaseCarryBVReport();
        },
        methods: {
            repurchaseCarryBVReport(){
            	let i = 0;
                let that = this;
                let token = localStorage.getItem('access_token');
                setTimeout(function(){
                   const table = $('#repurchase-carrybv-report').DataTable({
                        responsive: true,
                        ...
                        ordering: false,
                        ajax: {
                            url: apiAdminHost+'/show/carrybv/repurchase',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
