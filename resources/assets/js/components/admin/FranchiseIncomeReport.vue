	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Franchise Income Report</h4>
		    </div>
		</div>
		    ...
		    <div class="container">
		                            ...
		                            <div class="">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" required="" placeholder="Enter to user id" type="text" id="to_user_id">
                                            </div>
                                        </div>   
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>From User Id</label>
                                                <input class="form-control" required="" placeholder="Enter from user id" type="text" id="from_user_id">
                                            </div>
                                        </div>                                     
                                        <div class="row">
                                            <div class="col-md-12">
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="franchise-income-report" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
		                                    <th>Sr.No</th>
		                                    <th>To User Id</th>
            ...
            productReport(){
                ...
                setTimeout(function(){
                    const table = $('#franchise-income-report').DataTable({
                        ...
                        ajax: {
                            url: apiAdminHost+'/getfranchiseincome',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
