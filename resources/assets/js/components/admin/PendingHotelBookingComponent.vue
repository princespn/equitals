    ...
    <div class="content">
        <div class="">
            <div class="page-header-title">
                <h4 class="page-title">Pending Hotel Bookings</h4>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                <table id="pendinghotel-orders" class="table table-striped table-bordered dt-responsive" style="width: 100% !important;">
                                    <thead>
                                        <tr>
                                            <th>Sr.No</th>
                                            <th>Order Id</th>
                ...
                <div  class="modal-content">
                    ...
                    <div  class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <h4><span class="text-primary">Hotel Location </span>: <span class="text-muted">{{hotel_loc}}</span> 
                                        </h4>
                                         <h4><span class="text-primary">Hotel Location </span>: <span class="text-muted">{{hotel_loc}}</span> 
                                        </h4>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <form enctype="multipart/form-data" id="sendReplyForm">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="bootstrap-filestyle input-group">
                                        <textarea  rows="2" cols="10" class="remark form-control" id="remark" style="margin-bottom: 10px;"> </textarea>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary waves-effect waves-light" @click="onApproveClick">Confirm Booking</button>

                            <button type="button" class="btn btn-danger waves-effect waves-light" @click="onRejectClick">Cancel Booking</button>
                        </div>
                    </form>
                </div>
                <!-- /.modal-content -->
    ...
    export default {
        ...
        methods: {
            ...
            codOrders(){
                ...
                setTimeout(function(){
                    const table = $('#pendinghotel-orders').DataTable({
                        responsive: true,
                           ...
                           /* {
                            ...
                            },*/
                            {
                                render: function (data, type, row, meta) {
                                    ...
                                    return `
                                        <a href="javascript:void(0);" class="btn btn-primary text-success waves-effect" id="onActionClick" data-id="${row.id}" data-user-id="${row.user_id}" data-amount=""> Confirm / Cancel</a>` ;
                                }
                            },
                    ...
                    $('#pendinghotel-orders').on('click', '#view-detail',function(){
                        that.viewOrderDetails($(this).data('id'));
                    });
                    /*  Appprove details */
                    $('#pendinghotel-orders tbody').unbind('click').on('click', '#onActionClick', function (event){
                        var data = table.row($(this).parents('tr')).data();
                        let id = $(this).data('id');
                        that.OnPopupClick(id);
                    });
                   /* $('#pendinghotel-orders tbody').on('click', '#onRejectClick', function () {
                        var data = table.row($(this).parents('tr')).data();
                        var id = $(this).data('id');
            ...
            onApproveClick(){
                ...
                Swal({
                    ...
                    if (result.value) {
                        axios.post('approvehotelBookingRequest',
                        formData,
                        {
                            headers: {
                            ...
                            $('#pendinghotel-orders').DataTable().ajax.reload();
            ...
            onRejectClick(){
              ...
              //  var file = $("#file").val();
                ...
                Swal({
                    ...
                    if (result.value) {
                        axios.post('reject-hotelbooking-request', formData,
                        {
                            headers: {
                                'Content-Type': 'multipart/form-data'
                            }
            ...
            viewOrderDetails(orderid){
                ...
                axios.post(apiAdminHost+'/view-hotelbooking-details',{
                  ...
                  this.hotel_loc = this.booking_data.address.cityName;
                  this.postalCode = this.booking_data.address.postalCode;
            ...
            exportToExcel(){
                ...
                axios.post('get-hotel-booking', params).then(resp => {
                    if (resp.data.code == 200) {
                        ...
                        fileLink.setAttribute('download', 'Pending-Hotel-Booking.xls');
