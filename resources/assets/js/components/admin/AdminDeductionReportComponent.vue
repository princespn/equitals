...
<div class="content">
	<div class="">
	    <div class="page-header-title">
	        <h4 class="page-title">Admin Deduction Report</h4>
	    </div>
	</div>
	    ...
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-md-12">
	                <div class="panel panel-primary">
	                    <div class="panel-body">
	                        <table id="admin-dect-report" class="table table-striped table-bordered dt-responsive">
	                            <thead>
	                                <tr>
	                                   <th>Sr No</th>
                                       <th>User Id</th> 
    ...
    export default {
        ...
        methods: {
            ...
            productReport(){
                ...
                setTimeout(function(){
                    const table = $('#admin-dect-report').DataTable({
                        responsive: true,
                        retrieve: true,
                        destroy: true,
                        processing: false,
                        ...
                        ajax: {
                            url: apiAdminHost+'/deduction_report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
                        ...
                        columns: [
                            ...
                            },
                            {
                              ...
                              { render: function (data, type, row, meta,) {
                                   return `<span>${row.wallet_name}</span>`;
