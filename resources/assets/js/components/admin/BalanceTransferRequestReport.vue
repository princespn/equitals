	    ...
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-md-12">
	                <div class="panel panel-primary">
	                    <div class="panel-body">
	                        <table id="balance-transfer-report" class="table table-striped table-bordered dt-responsive">
	                            <thead>
	                                <tr>
	                                    <th>Sr No</th>
                                        <th>User ID</th>
    ...
    export default {
        ...
        methods: {
            ...
            productReport(){
                ...
                setTimeout(function(){
                    const table = $('#balance-transfer-report').DataTable({
                        responsive: true,
                        retrieve: true,
                        destroy: true,
                        processing: false,
                        ...
                        ajax: {
                            url: apiAdminHost+'/balance_transfer_report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
            ...
            exportToExcel(){
                ...
                axios.post('balance_transfer_report', params).then(resp => {
                    if(resp.data.code === 200){
                        ...
                        fileLink.setAttribute('download', 'balancetransfer.xls');
