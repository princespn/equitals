	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Working Wallet To Purchase Wallet Report</h4>
		    </div>
		</div>
		    ...
		    <div class="container">
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="working-purchase-report" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
		                                    <th>Sr.No</th>
		                                    <th>User Id</th>
                                            <th>Balance</th>
                                            <th>Working Wallet Amount</th> 
    ...
    export default {
        ...
        methods: {
            ...
            productReport(){
                ...
                setTimeout(function(){
                    const table = $('#working-purchase-report').DataTable({
                        responsive: true,
                        retrieve: true,
                        destroy: true,
                        processing: false,
                        ...
                        ajax: {
                            url: apiAdminHost+'/get-working-to-purchase-report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
