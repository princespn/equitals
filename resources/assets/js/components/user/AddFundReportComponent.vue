      ...
      <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
          <div class="row breadcrumbs-top">
            <div class="col-12">
              <h2 class="content-header-title float-left mb-0">Add Fund Report</h2>
...
export default {
  ...
  methods: {
    getLevelView() {
      ...
      setTimeout(function() {
        const table = $("#add-fund-report").DataTable({
          responsive: true,
          lengthMenu: [
            [10, 50, 100],
            [10, 50, 100]
          ...
          ordering: true,
          ajax: {
            url: apiUserHost + "confirm-fund-report",
            type: "POST",
            data: function(d) {
              i = 0;
              i = d.start + 1;
          ...
          columns: [
           ...
           /* {
            ...
            },*/
            {
              render: function(data, type, row, meta) {
                if (
                  row.top_up_date === null ||
                  row.top_up_date === undefined ||
                  row.top_up_date === ""
                ) {
                  return `-`;
                } else {
                  return moment(String(row.top_up_date)).format("YYYY/MM/DD");
                }
              }
            }
