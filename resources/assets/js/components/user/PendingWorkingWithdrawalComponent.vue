           ...
           <!--  <header class="section-header">
            ...
            <section class="card">
                <div class="card-block">
                    <h5 class="with-border text-center">Pending Team Withdrawals</h5>
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="pending-working-withdrawal" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Sr No</th>
                                        <th>N/W Type</th>
        ...
        getPackages(){
            ...
            getLevelView(){
                ...
                setTimeout(function(){
                    ...
                    const table = $('#pending-working-withdrawal').DataTable({
                        responsive: true,
                        ...
                        dom: 'lrtip',
                        ajax: {
                            url: apiUserHost+'all-withdraw-pending-reports',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
