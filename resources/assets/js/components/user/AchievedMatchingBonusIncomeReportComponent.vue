   ...
   <div class="container-fluid">
      <div class="row page-titles">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)">Rank Report</a></li>
         </ol>
      </div>
      <!-- row -->
      <div class="row">
 ...
 -->
               ...
               <div class="card-body">
                  <div class="table-responsive">
                     <table id="rank-matching-bonus-report" class="display" style="min-width: 845px">
                        <thead>
                           <tr>
                                 <th>Sr No</th>
                                 <th>Achieved Date</th>
...
export default {
  ...
  methods: {
    getTopupReport() {
      ...
      setTimeout(function () {
        const table = $("#rank-matching-bonus-report").DataTable({
          responsive: true,
          lengthMenu: [
            [10, 50, 100],
            [10, 50, 100],
          ...
          dom: "lrtip",
          ajax: {
            url: apiUserHost + "rank-matching-bonus-income",
            type: "POST",
            data: function (d) {
              i = 0;
              i = d.start + 1;
