          ...
          <div class="row breadcrumbs-top">
            <div class="col-12">
              <h2 class="content-header-title float-left mb-0">
               Deposit To Deposit Wallet Report
              </h2>
            </div>
          </div>
        </div>
              ...
              <div class="container-fluid">
                <div class="card card-payment">
                  ...
                  <div class="card-header">
                    <h4 class="card-title"> Deposit To Deposit Wallet Report</h4>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-body">
                          <table id="purchase-transfer-balance-report" class="table table-striped table-bordered complex-headers">
                                  <thead>
                                    <tr>
                                      <th>Sr.No</th>
    ...
    export default {
        ...
        methods:{
            getTopupReport(){
                ...
                setTimeout(function(){
                    that.table = $('#purchase-transfer-balance-report').DataTable({
                        responsive: true,
                        ...
                        dom:'lrtip',
                        ajax: {
                            url: apiUserHost+'purchase-transfer-balance-report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
