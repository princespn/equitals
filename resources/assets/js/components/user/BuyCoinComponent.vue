        ...
        <div class="main-content col-lg-12">
           <!--  <div class="d-lg-none"><a href="#" data-toggle="modal" data-target="#add-wallet" class="btn btn-danger btn-xl btn-between w-100 mgb-1-5x">Add your wallet address before buy <em class="ti ti-arrow-right"></em></a>
            ...
            <div class="content-area car">
                <div class="card-innr row">
                 <div class="obb" >
                    ...
                    <div class="card-text row">
                        <div class="col-lg-6">
                           <!--  <p><span>Date :</span> {{ico_arr.from_date}}</p> -->
                        <p><span>Price : </span> $ {{ico_arr.usd_rate}}  </p>
                        <p><span> Remaining Tokens : </span> {{ ico_arr.total_supply - ico_arr.sold_supply}}</p>
                        </div>
                      <div class="col-lg-6">
                            <p v-if="ico_arr.status=='Notavailable'">Phase Start ON</p><!--  <p v-else>Phase End In</p> -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3><span>Fund Wallet Balance : </span>  {{ico_arr.fund_wallet}}</h3>
                        </div>
                  ...
                  <div class="obb">
                    <div class="stepbox">
                        <span class="step-title green">Step 2</span>
                    </div>
                    <div class="card-head">
                        <h4 class="card-title">Amount of contribute</h4>
                    </div>
                    <div class="card-text">
                        <p>Enter your amount, you would like to contribute and calculate the amount of token you will received. The calculator helps to convert required currency to Token.</p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="amountBox">
                                    ...
                                    <div class="midbcoin"><span>=</span></div>
                                    <div class="finalamt">$ {{coinFinalAmt|ptow}}</div>
                                </div>
                            </div>
                        </div>
                        <div class="token-calc-note note note-plane"><em class="fas fa-times-circle text-danger"></em><span class="note-text">100  Token minimum contribution require.</span>
                        </div>
                ...
                <div class="obb">
                    <div class="stepbox">
                        <span class="step-title blue">Step 3</span>
                    </div>
                      <div class="card-head">
                    ...
                    <div class="pay-buttons">
                        ...
                        <div v-if="ico_arr.total_supply != ico_arr.sold_supply && ico_arr.status!='SoldOut'"  class="pay-button ">
                            <a href="#" class="btn btn-pay" @click="buyCoins">Buy Token <em class="ti ti-arrow-right"></em></a> 
                        </div> 
                ...
                <div class="obb" style="padding-top: 20px!important;">
                  <div class="token-balance">
                        <div class="token-balance-text">
                            <h4 class="card-title">Total Tokens</h4>
                            <span class="lead">{{ico_arr.total_supply}}<span></span></span>
                        </div>
                    </div>
                    <div class="token-balance token-balance-s2">
                        <h6 class="card-sub-title">Your Contribution</h6>
                        <ul class="token-balance-list">
                            <li class="token-balance-sub"><span class="lead">{{ico_arr.coin}}</span><span class="sub"> Token</span>
                            </li>
    ...
    export default {  
        ...
        methods:{
            buyCoins(){
                ...
                if(this.coin==''){
                   $( "#bcoin" ).focus();
                   this.$toaster.error('Please Enter Token'); 
                    return false;
                }
               ...
               this.$route.params.id
                    ...
                    Swal({
                        title: 'Are you sure?',
                        text: `You want to purchase Token`,
                        type: 'warning',
