          ...
          <div class="row breadcrumbs-top">
            <div class="col-12">
              <h2 class="content-header-title float-left mb-0">
                Purchase Receive Balance Report 
              </h2>
            </div>
          </div>
        </div>
              ...
              <div class="container-fluid">
                <div class="card card-payment">
                  ...
                  <div class="card-header">
                    <h4 class="card-title">Purchase Receive Balance Report </h4>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-body">
                          <table
                            id="purchase-receive-balance-report"
                            class="
...
export default {
  ...
  methods: {
    getTopupReport() {
      ...
      setTimeout(function () {
        that.table = $("#purchase-receive-balance-report").DataTable({
          responsive: true,
          lengthMenu: [
            [10, 50, 100],
            [10, 50, 100],
          ...
          dom: "lrtip",
          ajax: {
            url: apiUserHost + "user-purchase-receive-balance-report",
            type: "POST",
            data: function (d) {
              i = 0;
              i = d.start + 1;
