      ...
      <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
          <div class="row breadcrumbs-top">
            <div class="col-12">
              <h2 class="content-header-title float-left mb-0">Rank Report</h2>
            </div>
          </div>
        </div>
                  ...
                  <div class="card-body card-dashboard">
                    <div class="table-responsive">
                     <!--  <table
                      ...
                      {{token}}
                      <table id="direct-income-report" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                        <thead>
                          <tr>
                            <th>Sr No</th>
                            <th>Rank</th>
    ...
    getLevelIncome() {
      ...
      setTimeout(function() {
        const table = $("#direct-income-report").DataTable({
          ...
          ordering: true,
          ajax: {
            url: apiUserHost + "rank-report-get",
            type: "POST",
            data: function(d) {
              i = 0;
              i = d.start + 1;
