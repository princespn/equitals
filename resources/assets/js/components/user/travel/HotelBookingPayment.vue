                        ...
                        <table class="table table-bordered" v-if="orderhistory.length > 0">
                            ...
                            <tbody>
                             ...
                             <!--        <td>
                                    ...
                                    <td><a href="javascript:void(0)" @click="display_order(order.travel_class,order.booking_data,order.adultArr,order.childArr,order.remark)">View</a></td>
                                    <!-- <td>
      ...
      <div class="modal-body">
        <p>Hotel Booking Details </p>
            <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12 col-sm-3 text-center text-md-left d-lg-flex company-info">
                     <span class="align-middle"><img class="img-fluid" alt="" src="images/brands/flights/indigo.png"> </span> <span class="align-middle ml-lg-2"> <span class="d-block text-2 text-dark mt-1 mt-lg-0">IndiGo</span> <small class="text-muted d-block">{{flightInfo.itineraries[0].segments[0].carrierCode}} -
               ...
               <h1 class="text-success text-center"> Hotel Class :- {{travelClass}} </h1>
...
export default {
    ...
    methods: {
        ...
        display_order(travel_class,booking_data,adultArr,childArr,remark){
               //return false;
            this.showOrder=true
