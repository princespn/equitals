          ...
          <div class="row breadcrumbs-top">
            <div class="col-12">
              <h2 class="content-header-title float-left mb-0">
                Pending Purchase Balance Receive Report
              </h2>
            </div>
          </div>
        </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-body">
                          <table
                            id="pending-purchase-balance-report"
                            class="
...
export default {
  ...
  methods: {
    ...
    getTopupReport() {
      ...
      setTimeout(function () {
        that.table = $("#pending-purchase-balance-report").DataTable({
          responsive: true,
          lengthMenu: [
            [10, 50, 100],
            [10, 50, 100],
          ...
          dom: "lrtip",
          ajax: {
            url: apiUserHost + "pending-purchase-balance-request",
            type: "POST",
            data: function (d) {
              i = 0;
              i = d.start + 1;
