      ...
      <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
          <div class="row breadcrumbs-top">
            <div class="col-12">
              <h2 class="content-header-title float-left mb-0">Voucher Transaction Report</h2>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    getRoi() {
      ...
      //var lang = "Chinese";
      setTimeout(function() {
        const table = $("#voucherTransaction").DataTable({
          responsive: true,
          lengthMenu: [
            [10, 50, 100],
            [10, 50, 100]
          ...
          ajax: {
            url: apiUserHost + "voucherTransaction",
            type: "POST",
            data: function(d) {
              i = 0;
              i = d.start + 1;
          ...
          columns: [
            ...
            /*{
              render: function(data, type, row, meta) {
                return `<span> ${row.debit_coin}</span>`;
              }
            },*/
             {
              render: function(data, type, row, meta) {
           ...
           /* {
              render: function(data, type, row, meta) {
                return `<span> ${row.credit_coin}</span>`;
              }
            },*/
